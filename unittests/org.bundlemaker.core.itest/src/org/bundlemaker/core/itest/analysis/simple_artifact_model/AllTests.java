...
@RunWith(Suite.class)
@SuiteClasses({ ArtifactModelModifiedListenerTest.class, DependenciesFromToTest.class, GetChildByPathTest.class,
    ...
    TypeModuleChangeClassificationTest.class, Undo_AddArtifacts_Test.class, Undo_GroupCreateNew_Test.class,
    Undo_ModuleCreateNew_Test.class, Undo_ModuleRename_Test.class })
