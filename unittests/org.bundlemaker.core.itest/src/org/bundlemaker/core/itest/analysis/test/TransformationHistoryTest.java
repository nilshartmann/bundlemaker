...
public class TransformationHistoryTest extends AbstractSimpleArtifactModelTest {
  ...
  public void createGroupHistory() {
    ...
    // create a new group
    IGroupArtifact newGroup2Artifact = _binModel.getRootArtifact().getOrCreateGroup("NewGroup2");
  ...
  public void createModuleHistory() {
    ...
    // create a new group
    IModuleArtifact moduleArtifact = _binModel.getGroup2Artifact().getOrCreateModule("hallo", "1.2.3");
