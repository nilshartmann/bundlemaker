...
public class TransformationDslStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.bundlemaker.core.transformations.dsl.TransformationDslRuntimeModule());
	}
