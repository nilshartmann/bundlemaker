...
/**
 * <p>Implementiert eines gruppierenden Artefaktes
 * 
 * <p>Gruppierende Artefakte koennen anderen gruppierenden Artefakte 
 * oder Primarartefakte beinhalten
 * 
 * @author Kai Lehmann
...
public abstract class AbstractArtifactContainer extends AbstractArtifact {
		...
		public Dependency addDependency(IArtifact artifact){
			throw new UnsupportedOperationException(
					"Nur Blätter können Abhängigkeiten besitzen");		
		}
