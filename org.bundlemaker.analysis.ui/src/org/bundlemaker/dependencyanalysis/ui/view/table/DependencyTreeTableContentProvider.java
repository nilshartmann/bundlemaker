...
/**
 * <p>ContentProvider fuer den TreeViewer der Dependencies View zur Beschreibung
 * der Struktur des Models
 * 
 * <p>Dieser ContentProvider beschreib die Datenstruktur von Abhaengigkeiten
 * die ueber das Interface IDependency realisiert werden
 *
 * @author Kai Lehmann
 *
 */
public class DependencyTreeTableContentProvider implements ITreeContentProvider {
	...
	private final Comparator<IDependency> compareByViolations = new Comparator<IDependency>() {
		@Override
		public int compare(IDependency o1, IDependency o2) {
			Integer o1Violations = o1.getViolations() != null ? o1.getViolations().size(): 0;
			Integer o2Violations = o2.getViolations() != null ? o2.getViolations().size(): 0;
//			if( (o1Violations == 0) && (o2Violations == 0) ) {
//				return 0;
//			}
			o1Violations = o1Violations * o1.getWeight();
			o2Violations = o2Violations * o2.getWeight();
			return o2.getViolationWeight()-o1.getViolationWeight();
		}
	}; 
	...
	private final Comparator<IDependency> compareByFrom = new Comparator<IDependency>() {
		@Override
		public int compare(IDependency o1, IDependency o2) {
			return o2.getFrom().getName().compareTo(o1.getFrom().getName());
		}
	}; 
	...
	private final Comparator<IDependency> compareByTo = new Comparator<IDependency>() {
		@Override
		public int compare(IDependency o1, IDependency o2) {
			return o2.getTo().getName().compareTo(o1.getTo().getName());
		}
	}; 
