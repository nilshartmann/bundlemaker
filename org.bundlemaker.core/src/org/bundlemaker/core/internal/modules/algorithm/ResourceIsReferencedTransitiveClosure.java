 ...
 * </p>
 */
public class ResourceIsReferencedTransitiveClosure extends
		AbstractResourceClosureQuery {

	/**
	 * <p>
	 * Creates a new instance of type
	 * {@link ResourceIsReferencedTransitiveClosure}.
	 * </p>
	 * 
	 * @param modularizedSystem
	 */
	public ResourceIsReferencedTransitiveClosure(
	...
	public void resolveResource(IResource resource, ContentType contentType,
		...
		for (IType containedType : resource.getContainedTypes()) {
			...
			Set<IType> types = getModularizedSystem()
					.getTypeNameToReferringCache().get(
							containedType.getFullyQualifiedName());

			if (types == null || types.isEmpty()) {
				System.out.println("NO TYPE REFERS TO '"
						+ containedType.getFullyQualifiedName() + "'.");
				return;
			}
			...
			for (IType type : types) {
				...
				//
				IResource iResource = contentType.equals(ContentType.SOURCE) ? type
