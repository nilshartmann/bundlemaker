 ...
 * 
 */
public class Resource2IArtifactAdapter extends AbstractArtifact {
   ...
   */
  public Resource2IArtifactAdapter(String path, ArtifactCache artifactCache, IArtifact parent) {

    super(ArtifactType.Type, path);
