...
public class BundleManifestCreator {
	 ...
	 * @param context
	 */
	public BundleManifestCreator(IModularizedSystem modularizedSystem,
		...
		//
		_currentModule = new CurrentModule(modularizedSystem, resourceModule,
				context, manifestTemplate);
	}
	...
	protected void createBundleName() {
		...
		_newBundleManifest.setBundleName(_currentModule.getResourceModule()
				.getModuleIdentifier().getName());
	}

	protected void copyTemplateHeaders(ManifestContents newManifestContents,
			ManifestContents manifestTemplate) {
	...
	protected void copyOriginalHeaders(ManifestContents newManifestContents,
			ManifestContents existingManifest) {
