...
public interface ManifestConstants {
	...
	/** - */
	public static final List<String> ORIGINAL_HEADERS_NOT_TO_COPY = Arrays
			.asList(new String[] { Constants.BUNDLE_MANIFESTVERSION,
					Constants.BUNDLE_SYMBOLICNAME, Constants.BUNDLE_VERSION,
					Constants.IMPORT_PACKAGE, Constants.REQUIRE_BUNDLE,
					Constants.EXPORT_PACKAGE });

	/** - */
	public static final List<String> TEMPLATE_HEADERS_NOT_TO_COPY = Arrays
			.asList(new String[] { Constants.BUNDLE_MANIFESTVERSION,
					Constants.BUNDLE_SYMBOLICNAME, Constants.BUNDLE_VERSION,
					Constants.IMPORT_PACKAGE, Constants.REQUIRE_BUNDLE,
					Constants.EXPORT_PACKAGE,
					ManifestConstants.HEADER_EXCLUDED_IMPORTS,
					ManifestConstants.HEADER_IMPORT_TEMPLATE,
					ManifestConstants.HEADER_EXPORT_TEMPLATE,
