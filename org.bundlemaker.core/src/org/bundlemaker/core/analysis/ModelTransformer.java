...
import org.bundlemaker.core.internal.analysis.ArtifactCache;
...
public class ModelTransformer {
   ...
   * @throws Exception
   */
  public IArtifact transform(IModularizedSystem modularizedSystem) throws Exception {
  ...
  private IArtifact transform(IModularizedSystem modularizedSystem, IModule[] modules,
      ArtifactContainer artifactContainer) throws Exception {
