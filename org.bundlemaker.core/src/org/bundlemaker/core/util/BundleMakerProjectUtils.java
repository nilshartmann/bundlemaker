...
public class BundleMakerProjectUtils {
	 ...
	 */
	public static void dumpProblems(List<? extends IProblem> errors)
			throws CoreException {
		...
		if (!errors.isEmpty()) {
			...
			for (int i = 0; i < errors.size(); i++) {
				...
				if (problem.isError()) {
					...
					arguments[3] = Integer.valueOf(problem
							.getSourceLineNumber());
					...
					System.out.println(String.format(COMPILE_PROBLEM_MESSAGE,
							arguments));
				}
			}
		}
	 ...
	 * @throws IOException
	 */
	private static String[] extractProblematicLine(InputStream inputStream,
