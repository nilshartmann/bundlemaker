...
public class ExtensionRegistryTracker<T> implements IExtensionChangeHandler {
	 ...
	 */
	public ExtensionRegistryTracker(String extensionPointId,
			ExtensionLifecycleListener<T> lifecycleListener) {
	 ...
	 * {@inheritDoc}
	 */
	public final synchronized void addExtension(IExtensionTracker tracker,
		...
		try {
			...
			_tracker.registerObject(extension, extensionObject,
	...
	public final synchronized void removeExtension(IExtension extension,
			Object[] objects) {
