...
public interface IFileBasedContent {
	 ...
	 * {@link IFileBasedContent}. A {@link IFileBasedContent} <i>always</i> has
	 * one or more binary paths.
	 * </p>
	 * 
	 ...
	 * </p>
	 * <p>
	 * If this content entry is not a resource content (
	 * <code>isResourceContent()</code> returns <code>false</code>), an empty
	 ...
	 * <p>
	 * If this content entry is not a resource content (
	 * <code>isResourceContent()</code> returns <code>false</code>),
