...
public interface IBundleMakerProjectDescription {
	...
	/**
	 * <p>
	 * Adds a new type content entry with the specified binary root. The name
	 * and the version of the content entry are automatically extracted from the
	 * binary root.
	 * </p>
	 * 
	 * @param binaryRoot
	...
	/**
	 * <p>
	 * Adds a new type content entry with the specified name, version and binary
	 * root.
	 * </p>
	 * 
	 * @param name
	...
	/**
	 * <p>
	 * Adds a new resource content entry with the specified binary. The name and
	 * the version of the content entry are automatically extracted from the
	 * binary root.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Adds a new resource content entry with the specified binary and source
	 * root. The name and the version of the content entry are automatically
	 * extracted from the binary root.
	 * </p>
	 * 
	 * @param binaryRoot
	 * @param sourceRoot
	...
	/**
	 * <p>
	 * Adds a new resource content entry with the specified name, version,
	 * binary root.
	 * </p>
	 * 
	 * @param name
	...
	void addResourceContent(String name, String version,
			List<String> binaryRoots, List<String> sourceRoots);
	...
	/**
	 * <p>
	 * Clears the list of content entries. After calling this method the list of
	 * content entries is empty.
	 * </p>
	 */
	void clear();
}
