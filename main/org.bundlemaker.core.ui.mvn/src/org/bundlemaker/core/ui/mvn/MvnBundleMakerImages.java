/*******************************************************************************
 * Copyright (c) 2011-2012 Bundlemaker project team.
 ...
 */
public enum MvnBundleMakerImages {

  /**
   * the BundleMaker logo
   */
  MVN_PROJECT_CONTENT_PROVIDER("icons/mvn_project_provider.gif");
  ...
  /**
   * <p>
   * Creates a new instance of type {@link MvnBundleMakerImages}.
   * </p>
   *
   * @param path
   */
  private MvnBundleMakerImages(final String path) {
    this.path = path;
  }
