...
public class GraphicsToGraphics2DAdaptor extends Graphics
{
     ...
     * @param viewPort the <code>org.eclipse.swt.graphics.Rectangle</code> that defines the logical area being rendered
    ...
    public Rectangle getClip(Rectangle rect)
    {
        ...
        {
            rect.setBounds(new Rectangle(0, 0, Integer.MAX_VALUE, Integer.MAX_VALUE));
        }
        return rect;
    }
