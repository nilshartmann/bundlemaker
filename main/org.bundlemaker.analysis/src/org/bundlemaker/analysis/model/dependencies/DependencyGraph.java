...
public class DependencyGraph implements Serializable {
   ...
   * Zusammenhangskomponenten ueber den Algorithmus von Tarjan. Abschlieﬂend wird das Regelwerk auf den
  ...
  public DependencyGraph(Collection<IArtifact> artifacts) {
    ...
    cycleViolation = new Violation(Severity.ERROR, "Die Abh‰ngigkeit f¸hrt zu einem Zyklus");
