...
public class TransformationDslProposalProvider extends AbstractTransformationDslProposalProvider {
  ...
  private void addPackageProposals(ResourceSet resourceSet, ContentAssistContext context,ICompletionProposalAcceptor acceptor) {
    ...
    addPackageProposals(moduleArtifact, context, acceptor);
  }
  ...
  private List<? extends IFileBasedContent>  getFileBasedContent(EObject model) {
    ...
    List<? extends IFileBasedContent> fileBasedContent = bundleMakerProject.getProjectDescription().getFileBasedContent();
  ...
  /* (non-Javadoc)
   * @see org.bundlemaker.core.transformations.dsl.ui.contentassist.AbstractTransformationDslProposalProvider#completeModuleIdentifier_Modulename(org.eclipse.emf.ecore.EObject, org.eclipse.xtext.Assignment, org.eclipse.xtext.ui.editor.contentassist.ContentAssistContext, org.eclipse.xtext.ui.editor.contentassist.ICompletionProposalAcceptor)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.bundlemaker.core.transformations.dsl.ui.contentassist.AbstractTransformationDslProposalProvider#completeModuleIdentifier_Version(org.eclipse.emf.ecore.EObject, org.eclipse.xtext.Assignment, org.eclipse.xtext.ui.editor.contentassist.ContentAssistContext, org.eclipse.xtext.ui.editor.contentassist.ICompletionProposalAcceptor)
   */
  @Override
  public void completeModuleIdentifier_Version(EObject model, Assignment assignment, ContentAssistContext context,
    ...
    for (IFileBasedContent iFileBasedContent : fileBasedContent) {
      if (iFileBasedContent.isResourceContent()) {
        if (moduleIdentifier.getModulename() == null || moduleIdentifier.getModulename().equals(iFileBasedContent.getName())) {
  ...
  private void addPackageProposals(IArtifact root, ContentAssistContext context,ICompletionProposalAcceptor acceptor) {
    if (root == null) {
      return;
    }
    ...
    if (packageArtifact) {
      ...
      String packageName = getValueConverter().toString(root.getQualifiedName().replace('.', '/')+"/**", "STRING");
      // Create completion proposal
    ...
    Collection<IArtifact> children = root.getChildren();
    for (IArtifact iArtifact : children) {
      addPackageProposals(iArtifact, context, acceptor);
    }
  }
