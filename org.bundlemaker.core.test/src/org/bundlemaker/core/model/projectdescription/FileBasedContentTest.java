...
public class FileBasedContentTest {
  ...
  public void test() throws CoreException {
    ...
    fileBasedContent.getModifiableBinaryPaths().add(
        new RootPath(System.getProperty("user.dir")
    ...
    //
    assertEquals(1, fileBasedContent.getBinaryRootPaths().size());
    assertEquals(1, fileBasedContent.getSourceRootPaths().size());
    ...
    //
    assertEquals("com/springsource/bundlor/ClassPath.class", fileBasedContent

    .getBinaryResource(new Path("com/springsource/bundlor/ClassPath.class")).getPath());

    //
    assertEquals("com/springsource/bundlor/ClassPath.java", fileBasedContent

    .getSourceResource(new Path("com/springsource/bundlor/ClassPath.java")).getPath());
  }
}
