...
public class FileContentReaderTest {
  ...
  public void testBinaryDirectoryBasedContent() throws CoreException {
    ...
    //
    IBundleMakerProjectDescription projectDescription = createProjectDescription("bundlor", "1.0.0",
        new String[] { "classes" }, new String[] {});

    // get the directories
    List<IDirectory> directories = FileContentReader.getDirectories(projectDescription.getFileBasedContent("000001"),
        false);
  ...
  public void testBinaryJarFileBasedContent() throws CoreException {
    ...
    //
    IBundleMakerProjectDescription projectDescription = createProjectDescription("bundlor", "1.0.0",
        new String[] { "com.springsource.bundlor-1.0.0.RELEASE.jar" }, new String[] {});
  ...
  public void testBinaryMixedContent() throws CoreException {
    ...
    //
    IBundleMakerProjectDescription projectDescription = createProjectDescription("bundlor", "1.0.0", new String[] {
        "classes-partial_1.jar", "classes-partial_2" }, new String[] {});
  ...
  public void testSourceSplitPackage() throws CoreException {
    ...
    //
    IBundleMakerProjectDescription projectDescription = createProjectDescription("bundlor", "1.0.0",
        new String[] { "classes" }, new String[] { "src-1", "src-2" });
   ...
   * @throws CoreException
   */
  private IBundleMakerProjectDescription createProjectDescription(String name, String version, String[] binaryPaths,
      String[] sourcePaths) throws CoreException {

    // step 1: create project description
    File testEnvironment = new File(System.getProperty("user.dir"), "test-environment");

    //
    BundleMakerProjectDescription projectDescription = new BundleMakerProjectDescription(null);
    ...
    //
    projectDescription.addResourceContent(name, version, binaryPathsList, sourcePathsList);
