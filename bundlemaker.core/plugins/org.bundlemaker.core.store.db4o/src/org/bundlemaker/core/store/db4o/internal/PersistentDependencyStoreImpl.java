 ...
 */
public class PersistentDependencyStoreImpl implements
	...
	public final void init() {
		...
		try {
			...
			for (String clazz : classes[0]) {
				configuration.objectClass(classLoader.loadClass(clazz))
						.cascadeOnUpdate(true);
			}
