...
import org.bundlemaker.core._type.analysis.selectors.SuperTypeSelector;
 ...
 * 
 */
public class SuperTypeSelectorHandler extends AbstractArtifactSelectorHandler {
  ...
  protected IArtifactSelector createArtifactSelector(List<IBundleMakerArtifact> selectedArtifacts) throws Exception {
    ...
    return new SuperTypeSelector(artifact);
  }
