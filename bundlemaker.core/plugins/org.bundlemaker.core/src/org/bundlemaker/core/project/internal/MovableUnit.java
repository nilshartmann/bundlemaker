...
public class MovableUnit implements IMovableUnit {
  ...
  /** EMPTY_RESOURCE_LIST */
  private static final List<IProjectContentResource> EMPTY_RESOURCE_LIST = Collections.emptyList();
  ...
  private void setMovableUnit(IProjectContentResource resource, MovableUnit movableUnit) {
    ...
    // ((DefaultProjectContentResource) ((IResourceStandinNEW) resource).getResource()).setMovableUnit(movableUnit);
    // }
    // }
  }
}
