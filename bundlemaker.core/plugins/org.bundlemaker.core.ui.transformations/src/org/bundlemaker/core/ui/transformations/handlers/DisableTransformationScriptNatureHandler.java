...
public class DisableTransformationScriptNatureHandler extends AbstractBundleMakerHandler {
  ...
  protected void execute(ExecutionEvent event, ISelection selection) throws Exception {
    ...
    if (selection instanceof IStructuredSelection) {
      ...
      for (Iterator<?> it = structuredSelection.iterator(); it.hasNext();) {
        ...
        if (project != null) {
          try {
            TransformationScriptNature.removeTransformationScriptNature(project, null);
