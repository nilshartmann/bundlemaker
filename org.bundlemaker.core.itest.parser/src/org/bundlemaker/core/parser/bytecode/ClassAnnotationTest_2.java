...
public class ClassAnnotationTest_2 extends AbstractParserTest {
  ...
  protected void testResult(IModularizedSystem modularizedSystem, IResourceModule resourceModule) throws CoreException {
    ...
    assertResourceWithSingleTypeAndAllReferences(resourceModule, "de/test/Klasse.class", ContentType.BINARY,
        expectedReferences);

    //
    assertResourceWithSingleTypeAndAllReferences(resourceModule, "de/test/TestInterface.class", ContentType.BINARY,
        new ExpectedReference("de.test.Test", ReferenceType.TYPE_REFERENCE, false, false, true));

    //
    assertResourceWithSingleTypeAndAllReferences(resourceModule, "de/test/Test.class", ContentType.BINARY);
  }
}
